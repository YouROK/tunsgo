...
func (s *P2PServer) GinHandler(c *gin.Context) {
	...
	p2pResp, err := s.SendRequestProxy(p2pReq)
	if err != nil {
...
func (s *P2PServer) SendRequestProxy(reqData *P2PProxyRequest) (*P2PProxyResponse, error) {
...
func (s *P2PServer) doStreamRequest(pID peer.ID, reqData *P2PProxyRequest) (*P2PProxyResponse, error) {
	...
	log.Println("[P2Proxy] Запрос к", pID.String(), "Url:", reqData.Method, reqData.URL)
